 ...
 */
typedef int32_t (*graal_create_isolate_fn_t)(graal_create_isolate_params_t* params, graal_isolate_t** isolate, graal_isolatethread_t** thread);
 ...
 */
typedef int32_t (*graal_attach_thread_fn_t)(graal_isolate_t* isolate, graal_isolatethread_t** thread);
 ...
 * Returns 0 on success, or a non-zero value on failure.
 */
typedef int32_t (*graal_detach_thread_fn_t)(graal_isolatethread_t* thread);
 ...
 * Returns 0 on success, or a non-zero value on failure.
 */
typedef int32_t (*graal_detach_threads_fn_t)(graal_isolatethread_t* thread, graal_isolatethread_t** array, int32_t length);
 ...
 * Returns 0 on success, or a non-zero value on failure.
 */
typedef int32_t (*graal_tear_down_isolate_fn_t)(graal_isolatethread_t* isolateThread);
