...
#include <stdbool.h>
#include <stdint.h>
#include <polyglot_isolate_dynamic.h>
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_engine_builder_fn_t)(poly_thread thread, poly_engine_builder* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_engine_builder_option_fn_t)(poly_thread thread, poly_engine_builder engine_builder, const char* key_utf8, const char* value_utf8);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_engine_builder_build_fn_t)(poly_thread thread, poly_engine_builder engine_builder, poly_engine* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_engine_fn_t)(poly_thread thread, poly_engine* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_engine_close_fn_t)(poly_thread thread, poly_engine engine, bool cancel_if_executing);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_engine_get_languages_fn_t)(poly_thread thread, poly_engine engine, poly_language* language_array, size_t* size);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_context_builder_fn_t)(poly_thread thread, const char** permitted_languages, size_t length, poly_context_builder* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_context_builder_engine_fn_t)(poly_thread thread, poly_context_builder context_builder, poly_engine engine);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_context_builder_option_fn_t)(poly_thread thread, poly_context_builder context_builder, const char* key_utf8, const char* value_utf8);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_context_builder_allow_all_access_fn_t)(poly_thread thread, poly_context_builder context_builder, bool allow_all_access);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_context_builder_allow_io_fn_t)(poly_thread thread, poly_context_builder context_builder, bool allow_IO);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_context_builder_allow_native_access_fn_t)(poly_thread thread, poly_context_builder context_builder, bool allow_native_access);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_context_builder_allow_polyglot_access_fn_t)(poly_thread thread, poly_context_builder context_builder, bool allow_polyglot_access);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_context_builder_allow_create_thread_fn_t)(poly_thread thread, poly_context_builder context_builder, bool allow_create_thread);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_context_builder_allow_experimental_options_fn_t)(poly_thread thread, poly_context_builder context_builder, bool allow_experimental_options);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_context_builder_build_fn_t)(poly_thread thread, poly_context_builder context_builder, poly_context* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_context_fn_t)(poly_thread thread, const char** permitted_languages, size_t length, poly_context* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_context_close_fn_t)(poly_thread thread, poly_context context, bool cancel_if_executing);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_context_eval_fn_t)(poly_thread thread, poly_context context, const char* language_id, const char* name_utf8, const char* source_utf8, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_context_get_engine_fn_t)(poly_thread thread, poly_context context, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_context_get_bindings_fn_t)(poly_thread thread, poly_context context, const char* language_id, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_context_get_polyglot_bindings_fn_t)(poly_thread thread, poly_context context, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_can_execute_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_execute_fn_t)(poly_thread thread, poly_value value, poly_value* args, int32_t args_size, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_get_member_fn_t)(poly_thread thread, poly_value value, const char* utf8_identifier, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_put_member_fn_t)(poly_thread thread, poly_value value, const char* utf8_identifier, poly_value member);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_has_member_fn_t)(poly_thread thread, poly_value value, const char* utf8_identifier, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_boolean_fn_t)(poly_thread thread, poly_context context, bool value, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_int8_fn_t)(poly_thread thread, poly_context context, int8_t value, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_int16_fn_t)(poly_thread thread, poly_context context, int16_t value, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_int32_fn_t)(poly_thread thread, poly_context context, int32_t value, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_int64_fn_t)(poly_thread thread, poly_context context, int64_t value, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_uint8_fn_t)(poly_thread thread, poly_context context, uint8_t value, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_uint16_fn_t)(poly_thread thread, poly_context context, uint16_t value, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_uint32_fn_t)(poly_thread thread, poly_context context, uint32_t value, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_float_fn_t)(poly_thread thread, poly_context context, float value, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_double_fn_t)(poly_thread thread, poly_context context, double value, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_character_fn_t)(poly_thread thread, poly_context context, int16_t character, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_string_utf8_fn_t)(poly_thread thread, poly_context context, const char* string, size_t length, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_null_fn_t)(poly_thread thread, poly_context context, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_object_fn_t)(poly_thread thread, poly_context context, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_array_fn_t)(poly_thread thread, poly_context context, const poly_value* value_array, int64_t array_length, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_has_array_elements_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_get_array_element_fn_t)(poly_thread thread, poly_value value, int64_t index, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_set_array_element_fn_t)(poly_thread thread, poly_value value, int64_t index, poly_value element);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_remove_array_element_fn_t)(poly_thread thread, poly_value value, int64_t index, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_get_array_size_fn_t)(poly_thread thread, poly_value value, int64_t* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_is_null_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_is_boolean_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_is_string_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_is_number_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_fits_in_float_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_fits_in_double_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_fits_in_int8_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_fits_in_int16_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_fits_in_int32_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_fits_in_int64_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_fits_in_uint8_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_fits_in_uint16_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_fits_in_uint32_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_as_string_utf8_fn_t)(poly_thread thread, poly_value value, char* buffer, size_t buffer_size, size_t* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_to_string_utf8_fn_t)(poly_thread thread, poly_value value, char* buffer, size_t buffer_size, size_t* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_as_boolean_fn_t)(poly_thread thread, poly_value value, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_as_int8_fn_t)(poly_thread thread, poly_value value, int8_t* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_as_int16_fn_t)(poly_thread thread, poly_value value, int16_t* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_as_int32_fn_t)(poly_thread thread, poly_value value, int32_t* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_as_int64_fn_t)(poly_thread thread, poly_value value, int64_t* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_as_uint8_fn_t)(poly_thread thread, poly_value value, uint8_t* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_as_uint16_fn_t)(poly_thread thread, poly_value value, uint16_t* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_as_uint32_fn_t)(poly_thread thread, poly_value value, uint32_t* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_as_float_fn_t)(poly_thread thread, poly_value value, float* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_value_as_double_fn_t)(poly_thread thread, poly_value value, double* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_language_get_id_fn_t)(poly_thread thread, poly_language language, char* utf8_result, size_t buffer_size, size_t* length);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_get_last_error_info_fn_t)(poly_thread thread, const poly_extended_error_info** result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_function_fn_t)(poly_thread thread, poly_context context, poly_callback callback, void* data, poly_value* value);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_get_callback_info_fn_t)(poly_thread thread, poly_callback_info callback_info, size_t* argc, poly_value* argv, void** data);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_throw_exception_fn_t)(poly_thread thread, const char* utf8_message);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_delete_reference_fn_t)(poly_thread thread, poly_reference reference);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_create_reference_fn_t)(poly_thread thread, poly_handle handle, poly_reference* reference);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_open_handle_scope_fn_t)(poly_thread thread);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_close_handle_scope_fn_t)(poly_thread thread);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_get_last_exception_fn_t)(poly_thread thread, poly_exception* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_exception_is_syntax_error_fn_t)(poly_thread thread, poly_exception exception, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_exception_is_cancelled_fn_t)(poly_thread thread, poly_exception exception, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_exception_is_internal_error_fn_t)(poly_thread thread, poly_exception exception, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_exception_has_object_fn_t)(poly_thread thread, poly_exception exception, bool* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_exception_get_object_fn_t)(poly_thread thread, poly_exception exception, poly_value* result);
 ...
 *  @since 19.0
 */
typedef poly_status (*poly_exception_get_stack_trace_fn_t)(poly_thread thread, poly_exception exception, char* buffer, size_t buffer_size, size_t* result);
